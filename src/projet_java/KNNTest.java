...
public class KNNTest {
	...
	public static void parsingTest() {
		...
		byte[][][] images = KNN.parseIDXimages(Helpers.readBinaryFile("C:\\Users\\LENOVO\\Desktop\\Projet_java\\datasets\\10-per-digit_images_train"));
		byte[] labels = KNN.parseIDXlabels(Helpers.readBinaryFile("C:\\Users\\LENOVO\\Desktop\\Projet_java\\datasets\\10-per-digit_labels_train"));
